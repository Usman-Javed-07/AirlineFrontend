...
document.getElementById("toggleExtras").addEventListener("click", () => {
  ...
  extrasSection.style.display =
    extrasSection.style.display === "none" ? "block" : "none";
});

// Show pickup/dropoff fields
document
  .getElementById("pickupEnabled")
  .addEventListener("change", function () {
    document.getElementById("pickupContainer").style.display = this.checked
      ? "block"
      : "none";
  });

document
  .getElementById("dropoffEnabled")
  .addEventListener("change", function () {
    document.getElementById("dropoffContainer").style.display = this.checked
      ? "block"
      : "none";
  });
